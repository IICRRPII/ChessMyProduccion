...
router.get('/admin/:id', getUsuarioById1);
...
router.get('/getCursoByToken/:token', getCursoByToken);
...
router.delete('/eliminarAlumnoDelCurso', eliminarAlumnoToCurso );
...
router.get('/search-Pago/:id', isAdmin, searchPago);
...
//router.post('/profile/:idUsuario/image',verifyToken, upload.single('image'), uploadProfileImage);
router.post('/profile/:idUsuario/image', upload.single('image'), uploadProfileImage);

// Obtener perfil
//router.get('/profile/:idUsuario',verifyToken, getProfile);
router.get('/profile/:idUsuario', getProfile);

// Actualizar información de perfil
//router.put('/profile/:idUsuario/info',verifyToken, updateProfileInfo);
router.put('/profile/:idUsuario/info', updateProfileInfo);
